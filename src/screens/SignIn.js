  ...
  const handleSubmit = async (event) => {
    ...
    switch (enteredRole) {
      case "admin":
        try {
          ...
          const response = await axios.post(
            "ec2-65-0-133-29.ap-south-1.compute.amazonaws.com:80/api/auth/admin",
            {
              email: enteredEmail,
      ...
      case "faculty":
        try {
          const response = await axios.post(
            "ec2-65-0-133-29.ap-south-1.compute.amazonaws.com:80/api/auth/faculty",
            {
              email: enteredEmail,
              password: enteredPassword,
            },
      ...
      case "student":
        try {
          const response = await axios.post(
            "ec2-65-0-133-29.ap-south-1.compute.amazonaws.com:80/api/auth/student",
            {
              email: enteredEmail,
              password: enteredPassword,
            },
